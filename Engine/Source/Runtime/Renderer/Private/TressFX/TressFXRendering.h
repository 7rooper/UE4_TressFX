...
public:
	...
	*/
	bool DrawPrims(FRHICommandListImmediate& RHICmdList, const class FViewInfo& View, FDrawingPolicyRenderState& DrawRenderState, bool bWriteCustomStencilValues, ETressFXRenderUsage UsageType = ETressFXRenderUsage::TFXRU_PPLL);
