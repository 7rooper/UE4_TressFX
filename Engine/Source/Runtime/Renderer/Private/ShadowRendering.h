...
public:
	...
	void SetBlendStateForProjection(FGraphicsPipelineStateInitializer& GraphicsPSOInit, bool bProjectingForForwardShading, bool bMobileModulatedProjections /*@third party code - BEGIN TressFX*/, bool bSceneHasTressFX /*@third party code - END TressFX*/) const;

	/**
	 * Projects the shadow onto the scene for a particular view.
	 */
	void RenderProjection(FRHICommandListImmediate& RHICmdList, int32 ViewIndex, const class FViewInfo* View, const class FSceneRenderer* SceneRender, bool bProjectingForForwardShading, bool bMobile /*@third party code - BEGIN TressFX*/ ,bool InbTressFXInScene = false /*@third party code - END TressFX*/) const;
	...
	void RenderOnePassPointLightProjection(FRHICommandListImmediate& RHICmdList, int32 ViewIndex, const FViewInfo& View, bool bProjectingForForwardShading /*@third party code - BEGIN TressFX*/ ,bool bSceneHasTressFX = false /*@third party code - END TressFX*/) const;
...
template<bool bModulatedShadows /*@third party code - BEGIN TressFX*/, bool bTressFXShadows = false /*@third party code - END TressFX*/>
...
public:
	...
	void Set(FRHICommandList& RHICmdList, FShader* Shader, const FSceneView& View, const FProjectedShadowInfo* ShadowInfo)
	{
		...
		SceneTextureParameters.Set(RHICmdList, ShaderRHI, View.FeatureLevel,  /*@third party code - BEGIN TressFX*/ bTressFXShadows ? ESceneTextureSetupMode::AllWithTFXSceneDepthSeparate : /*@third party code - END TressFX*/ ESceneTextureSetupMode::All);
 ...
 */
template<uint32 Quality, bool bUseFadePlane = false, bool bModulatedShadows = false, bool bUseTransmission = false /*@third party code - BEGIN TressFX*/ ,bool bTressFXShadows = false, bool bRayTracingEnabled = false /*@third party code - END TressFX*/>
...
public:
	...
	static void ModifyCompilationEnvironment(const FGlobalShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment)
	{
		...
		OutEnvironment.SetDefine(TEXT("RAYTRACING_ENABLED"), (uint32)(bRayTracingEnabled ? 1 : 0));
		/*@third party code - END TressFX*/
...
protected:
	TShadowProjectionShaderParameters<bModulatedShadows /*@third party code - BEGIN TressFX*/, bTressFXShadows /*@third party code - END TressFX*/> ProjectionParameters;
 ...
 */
// Quality = 0 / 1
template <uint32 Quality, bool bUseTransmission = false /*@third party code - BEGIN TressFX*/, bool bTressFXShadows = false /*@third party code - END TressFX*/>
...
template<uint32 Quality, bool bUseFadePlane /*@third party code - BEGIN TressFX*/, bool bTressFXShadows = false, bool bRayTracingEnabled = false /*@third party code - END TressFX*/>
class TDirectionalPercentageCloserShadowProjectionPS : public TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>
{
...
public:
	...
	TDirectionalPercentageCloserShadowProjectionPS(const ShaderMetaType::CompiledShaderInitializerType& Initializer) :
		TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>(Initializer)
	{
	...
	static void ModifyCompilationEnvironment(const FGlobalShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment)
	{
		TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>::ModifyCompilationEnvironment(Parameters, OutEnvironment);
		OutEnvironment.SetDefine(TEXT("USE_PCSS"), 1);
	}

	static bool ShouldCompilePermutation(const FGlobalShaderPermutationParameters& Parameters)
	{
		return TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>::ShouldCompilePermutation(Parameters)
	...
	virtual void SetParameters(
		...
		const FProjectedShadowInfo* ShadowInfo) override
	{
		TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>::SetParameters(RHICmdList, ViewIndex, View, ShadowInfo);
	...
	*/
	virtual bool Serialize(FArchive& Ar) override
	{
		bool bShaderHasOutdatedParameters = TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>::Serialize(Ar);
		Ar << PCSSParameters;
		return bShaderHasOutdatedParameters;
	}
...
template<uint32 Quality, bool bUseFadePlane /*@third party code - BEGIN TressFX*/, bool bTressFXShadows = false, bool bRayTracingEnabled = false /*@third party code - END TressFX*/>
class TSpotPercentageCloserShadowProjectionPS : public TShadowProjectionPS<Quality, bUseFadePlane /*@third party code - BEGIN TressFX*/, bTressFXShadows, bRayTracingEnabled /*@third party code - END TressFX*/>
{
